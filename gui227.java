...
public class gui227 extends JFrame {
    ...
    public void jactionPerformed(ActionEvent e) {
        if( checkValidity( jTextField1.getText(),jTextField2.getText(),jTextField3.getText()) ){
            validPackets++;
            Packet packet = new Packet( jTextField1.getText() ,jTextField2.getText(),jTextField3.getText());
            Main.Routers.get(Integer.parseInt(jTextField2.getText())).addToPCconnectedQ(packet);
            //p.add(pack);
        }
