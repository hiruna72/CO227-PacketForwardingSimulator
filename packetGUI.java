...
public class packetGUI extends JFrame {
    ...
    private JButton injectBtn,exit,minimize,graphBtn;
    ...
    private int Routers = 10, validPackets = 0;
    public static ArrayList<Packet> p = new ArrayList<Packet>();
    private networkPlot graph1;
    protected Viewer viewer;
    
    

    public packetGUI(networkPlot graph){
        // frame creating
        super();
        this.graph1 = graph;
...
//        minimize.addMouseListener(this);
        ...
        // inject button
        graphBtn = new JButton("Show graph");
        graphBtn.setSize(100, 40);
        graphBtn.setLocation(440, 350);
        ...
        resultsTable.setFont(new java.awt.Font("Tahoma", Font.PLAIN, 13)); // NOI18N
